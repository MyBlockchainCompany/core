...
echo 'alias mbc-test="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/MyBlockchainCompany/core.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/MyBlockchainCompany/core.git'"
...
rm -rf "$HOME/.config/@mbc-test"
rm -rf "$HOME/.config/@mbc-test"
rm -rf "$HOME/.config/mbc-test-core"
